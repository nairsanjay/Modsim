...
for i=0:step_size:time
    ...
    t9=in_to_quar*ho_human*step_size;
    t10=reco_rate*quar*step_size;
    t11=immune_rate*quar*step_size;
    t12=death_rate*quar*step_size;
    
    
    total=total+t1+t3+t4+t9;
    
    
    un_mosq=un_mosq+t5-t7-t8;
    vector=vector-t6+t8;
    
    un_human=un_human+t1-t2+t10;
    ho_human=ho_human+t2-t3-t4-t1-t9;
    im_human=im_human+t3+t11;
    dead_human=dead_human+t4+t12;
    quar=t9-t10-t11-t12;
    A_array(1,j)=total;
    B_array(1,j)=vector;
